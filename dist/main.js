...
const DOMModule=(()=>{
    ...
    const editFuncMod=(()=>{
        ...
        const getCurrentDate=()=>{
            ...
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(today,'yyyy-MM-dd');
        };
        return {taskEdit};
    })();
    ...
    const renderTaskMod=(()=>{
        ...
        _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('loadFirstTask',renderTask);
        return{renderTask};
    })();
    ...
    const taskTabCreation = (() =>{
        ...
        _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('userStorageLoaded',generateTaskTabs);
    })();
})();

/***/ }),

/***/ "./src/functions/localStorage.js":
/*!***************************************!*\
  !*** ./src/functions/localStorage.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const localStorageModule=(()=>{
    ...
    _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('arraySent',checkStorage);
    ...
    const getFromStorage=()=>{
        ...
        _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('gettingUserStorage',taskStorageArrayObject);
    };
    ...
    _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('taskStorageChange',saveToStorage);
    _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('subTaskArrayChange',saveToStorage);
    _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('tabElementChange',saveToStorage);
...
const taskObjModule = (()=>{
    ...
    const sendTaskStorageArray=(x)=>{
        if(x){
            _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('arraySent',taskStorageArray);
        };
    };
    _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('DOMLoaded',sendTaskStorageArray);
    ...
    const loadUserTasks=(x)=>{
        ...
        _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('userStorageLoaded',taskStorageArray);
        _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('loadFirstTask',taskStorageArray[0]);
        setCurrentTask(taskStorageArray[0]);
        console.log(`this is the task storage array ${taskStorageArray}`);
    };
    _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.subscribe('gettingUserStorage',loadUserTasks);
    ...
    const deleteTask=(deleteButton)=>{
        ...
        if(deleteButton.getAttribute('data-subtask-ID')){
            ...
            _pubsub__WEBPACK_IMPORTED_MODULE_0__.pubsub.publish('subTaskArrayChange',taskStorageArray);
        };
...
/* harmony import */ var _functions_localStorage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/localStorage */ "./src/functions/localStorage.js");
/* harmony import */ var _functions_pubsub__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/pubsub */ "./src/functions/pubsub.js");
